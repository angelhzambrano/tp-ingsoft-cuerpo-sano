...
def fix_all_certificates(apps, schema_editor):
    """Replace ALL trainer certificates with the generic one"""
    ...
    # Assign to ALL trainers (replace any existing certificates)
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('entrenadores', '0005_assign_generic_certificates'),
    ]

    operations = [
        migrations.RunPython(fix_all_certificates, reverse_fix),
    ]
